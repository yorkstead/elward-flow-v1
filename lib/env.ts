...
const serverEnvironmentSchema = z.object({
  ...
  AUTH_SECRET: z.string().min(32).default('synthetic_build_secret_32_characters_minimum'),
  DATABASE_URL: z.string().min(1).default('postgresql://postgres:postgres@localhost:5432/elward_flow'),
